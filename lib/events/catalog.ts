...
export const MOBILE_EVENT_DEFINITIONS: EventDefinition[] = [
  ...
  { name: MOBILE_EVENTS.returnedNextDay, label: "Returned next day", category: "engagement", description: "Day-1 return — primary activation.", properties: [], skanConversionValue: 20 },
...
/** Apple SKAN-style coarse conversion value map (0–63). Highest value wins in a window. */
